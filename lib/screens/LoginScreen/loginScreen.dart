...
class _LoginScreenState extends State<LoginScreen> {
  ...
  bool _isLoading = false; // Add this variable for loading indicator
  ...
  Future<void> _verifyPhoneNumber(String phoneNumber) async {
    ...
    setState(() {
      _isLoading = true; // Set loading to true when initiating verification
    });
    ...
    setState(() {
      _isLoading = false; // Set loading to false after codeSent
    });
  }
